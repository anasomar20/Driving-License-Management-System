...
namespace DVLD_Project
{
    public partial class frmTakeTest : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //  test.CreatedByUserID = clsUser.FindByUsername(Global.CurrentUser).UserID;
            if (MessageBox.Show("Are you sure you want to save? After that you cannot change the PassFail results after you save",
                "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.OK)
            {
                return;
            }
